 ...
 * Generated for Laravel 5.6.20 on 2018-05-07 10:53:23.
 *
...
namespace Berkayk\OneSignal { 
    ...
    class OneSignalFacade {
        ...
        {
            return \Berkayk\OneSignal\OneSignalClient::sendNotificationUsingTags($message, $tags, $url, $data, $buttons, $schedule);
        }
...
namespace Spatie\LaravelTwitterStreamingApi { 
    ...
    class TwitterStreamingApiFacade {
        ...
        {
            return \Spatie\LaravelTwitterStreamingApi\TwitterStreamingApi::publicStream();
        }
        ...
        {
            return \Spatie\LaravelTwitterStreamingApi\TwitterStreamingApi::userStream();
        }
